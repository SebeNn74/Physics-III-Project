...
public class WeightView extends JPanel {
    ...
    public void createPushJTextField() {
        ...
        pushJTextField.setBounds(480, 130, 90, 30);
    ...
    public void createPushJLabel() {
        ...
        pushJLabel.setBounds(430, 130, 20, 30);
